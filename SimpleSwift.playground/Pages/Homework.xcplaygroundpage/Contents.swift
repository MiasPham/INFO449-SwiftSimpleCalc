...
func calculate(_ arg: String) -> Int {
    ...
    for el in arg.split(separator: " ") {
        tokens.append(String(el))
    }
...
func calculate(_ args: [String]) -> Double {
    ...
    default:
        let ops = args[1]
        let num1 = Double(args[0]) ?? 0.0
        let num2 = Double(args[2]) ?? 0.0
        switch ops {
        case "+":
            return num1 + num2
        case "-":
